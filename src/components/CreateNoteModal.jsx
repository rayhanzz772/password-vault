            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
              {availableCategories.map((category) => {
                ...
                return (
                  ...
                  >
                    <Icon className={`w-5 h-5 ${isSelected ? `text-${category.color}-600 dark:text-${category.color}-400` : 'text-slate-500'}`} />
                    <span className={`text-sm font-medium ${isSelected ? `text-${category.color}-700 dark:text-${category.color}-300` : 'text-slate-700 dark:text-slate-300'}`}>
                      {category.name}
                    </span>
                  </button>
                );
