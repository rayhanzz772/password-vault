      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl w-full max-w-3xl my-8">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6 max-h-[calc(100vh-12rem)] overflow-y-auto">
          ...
          <div className="flex items-start gap-3 p-4 bg-primary-50 dark:bg-primary-900/20 border border-primary-200 dark:border-primary-800 rounded-xl">
            ...
            <div className="text-sm text-primary-800 dark:text-primary-200">
              ...
              <p className="text-primary-700 dark:text-primary-300">
                Your note will be encrypted with your master password before being stored.
              </p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
              {availableCategories.map((category) => {
                ...
                return (
                  ...
                  >
                    <Icon className={`w-5 h-5 ${isSelected ? 'text-primary-600 dark:text-primary-400' : 'text-slate-500'}`} />
                    <span className={`text-sm font-medium ${isSelected ? 'text-primary-700 dark:text-primary-300' : 'text-slate-700 dark:text-slate-300'}`}>
                      {category.name}
                    </span>
                  </button>
                );
          ...
          <div className="flex gap-3 pt-4 border-t border-slate-200 dark:border-slate-700">
            ...
            <button
              type="submit"
              disabled={isLoading || !formData.title.trim() || !formData.note.trim()}
