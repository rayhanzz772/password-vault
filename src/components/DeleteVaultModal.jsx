...
const DeleteVaultModal = ({ isOpen, onClose, vaultItem, onDelete, isDeleting }) => {
  ...
  const handleDelete = async () => {
    ...
    if (result.success) {
      ...
      setError(result.error || 'Failed to delete. Please check your master password.');
    }
  };
          ...
          <div className="p-6">
            ...
            {step === 1 && (
              ...
              >
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {vaultItem.category_name && (
                          <span className="inline-block mt-2 px-2 py-1 text-xs font-medium bg-slate-200 dark:bg-slate-700 text-slate-700 dark:text-slate-300 rounded-lg">
                            {vaultItem.category_name}
                          </span>
                        )}
                      </div>
                  ...
                  {/* Warning Message */}
                  <div className="bg-red-50 dark:bg-red-900/20 border-2 border-red-200 dark:border-red-900/50 rounded-2xl p-4">
                  ...
                  <div className="flex gap-3 pt-2">
                    <button
                      onClick={onClose}
                      disabled={isDeleting}
                      className="flex-1 px-4 py-3 rounded-xl font-semibold text-slate-700 dark:text-slate-300 bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-600 transition-all disabled:opacity-50"
                    >
                      Cancel
                    </button>
                    <button
                      ...
                      className="flex-1 px-4 py-3 rounded-xl font-semibold text-white bg-gradient-to-r from-red-500 to-rose-600 hover:from-red-600 hover:to-rose-700 shadow-lg hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:shadow-lg"
                    >
                      Continue
                    </button>
                  </div>
              ...
              {step === 2 && (
                <div className="space-y-4">
                    ...
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-blue-800 dark:text-blue-200">
                          Enter your master password to authorize this deletion. This ensures only you can delete your passwords.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <button
                        ...
                        className="absolute right-3 top-1/2 -translate-y-1/2 p-2 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-lg transition-colors"
                      >
                        {showPassword ? (
                  ...
                  {/* Final Confirmation */}
                  <div className="bg-amber-50 dark:bg-amber-900/20 border-2 border-amber-200 dark:border-amber-900/50 rounded-2xl p-4">
                    <p className="text-sm text-amber-900 dark:text-amber-100 text-center font-medium">
                      🔒 Last chance! Click "Delete Forever" to permanently remove this password.
                    </p>
                  </div>
                  ...
                  <div className="flex gap-3 pt-2">
                    ...
                    <button
                      ...
                      className="flex-1 px-4 py-3 rounded-xl font-semibold text-white bg-gradient-to-r from-red-500 to-rose-600 hover:from-red-600 hover:to-rose-700 shadow-lg hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:shadow-lg flex items-center justify-center gap-2"
                    >
                      {isDeleting ? (
                        <>
