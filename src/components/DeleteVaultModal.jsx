            ...
            <div className="space-y-4">
              <div className="bg-slate-50 dark:bg-slate-900 rounded-2xl p-4 border-2 border-red-200 dark:border-red-900/50">
                <div className="flex items-start gap-3">
                  <div
                    className={`w-12 h-12 bg-gradient-to-br ${categoryGradient} rounded-xl flex items-center justify-center flex-shrink-0`}
                  >
              ...
              <div>
                <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">
                  Type{" "}
                  <span className="px-2 py-0.5 bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-300 rounded font-mono font-bold">
                    DELETE
                  </span>{" "}
                  to confirm
                </label>
